...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="index.php">Rajshahi University of Engineering & Technology</a>
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Rajshahi University of Engineering & Technology</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
