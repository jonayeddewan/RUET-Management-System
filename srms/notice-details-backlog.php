...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="index.php">RUET Management System</a>
        ...
        <div class="container my-5">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <?php
                    $noticeid = $_GET['nid'];
                    $sql = "SELECT * from tblbacklognotice where id='$noticeid'";
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; RUET Management System <?php echo date('Y'); ?></p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
