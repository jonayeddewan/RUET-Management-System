...
?>
    ...
    <head>
        ...
        <title>Admin Manage Backlog Notices</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Manage Backlog Notices</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li>Notices</li>
                                        <li class="active">Manage Short Semester Notices</li>
                                    </ul>
                                </div>
                                                        ...
                                                        if ($query->rowCount() > 0) {
                                                            foreach ($results as $result) {   ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="manage-notice-short.php?id=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Do you really want to delete the notice?');" title="Delete this Record" class="btn btn-danger btn-xs">Delete </a>
