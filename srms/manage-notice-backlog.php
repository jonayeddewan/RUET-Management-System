                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Notices</li>
                                        <li class="active">Manage Backlog Notices</li>
                                    </ul>
                                </div>
                                                        ...
                                                        if ($query->rowCount() > 0) {
                                                            foreach ($results as $result) {   ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="manage-notices-backlog.php?id=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Do you really want to delete the notice?');" title="Delete this Record" class="btn btn-danger btn-xs">Delete </a>
